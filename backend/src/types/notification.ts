 ...
 * 
 * Enum defining all possible notification event types in the system.
 * These events trigger in-app notifications (badge + toast).
 */
 ...
 * 
 * Structure of the JSONB payload stored in notifications table.
