  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        {displayBadge && (
          <span
            className="absolute top-0 right-0 inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1.5 text-xs font-bold leading-none text-white bg-red-600 rounded-full"
            aria-live="polite"
            aria-atomic="true"
          >
            {displayBadge}
